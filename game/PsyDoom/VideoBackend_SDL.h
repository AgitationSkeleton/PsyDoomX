...
private:
    ...
    int             mFbTexW;                // Width of the framebuffer texture in pixels
    int             mFbTexH;                // Height of the framebuffer texture in pixels
    int             mFbTexPitch;            // Row pitch in bytes from SDL_LockTexture
};
