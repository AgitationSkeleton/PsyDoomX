...
bool sendBytes(const void* const, const int32_t) noexcept {
    return false;
}

bool recvBytes(void*, const int32_t) noexcept {
    return false;
}

bool sendTickPacket(const NetPacket_Tick&) noexcept {
    return false;
}
...
bool recvTickPacket(NetPacket_Tick&, std::chrono::system_clock::time_point&) noexcept {
    return false;
}
