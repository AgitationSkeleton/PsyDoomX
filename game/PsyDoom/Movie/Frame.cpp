...
//------------------------------------------------------------------------------------------------------------------------------------------
// Reads past a frame without decoding it. See the header.
//------------------------------------------------------------------------------------------------------------------------------------------
bool Frame::readSkip(CDXAFileStreamer& cdStreamer, const uint8_t channelNum) noexcept {
    clear();
    const bool bSuccess = demuxFrame(cdStreamer, channelNum);
