...
void initCfgSerialization_Controls() noexcept {
    ...
    cfg.digital_moveBackward = CONTROL_FIELD(Digital_MoveBackward, "S, Down");
    cfg.digital_strafeLeft = CONTROL_FIELD(Digital_StrafeLeft, "A");
    cfg.digital_strafeRight = CONTROL_FIELD(Digital_StrafeRight, "D");
    cfg.digital_turnLeft = CONTROL_FIELD(Digital_TurnLeft, "Left");
    cfg.digital_turnRight = CONTROL_FIELD(Digital_TurnRight, "Right");

    // In-game actions & modifiers
    cfg.action_use = CONTROL_FIELD_WITH_DOC(
        "In-game actions & modifiers",
        Action_Use,
        "Space, E, Mouse Right, Gamepad A, Gamepad X, Gamepad RightStick"
    );

    cfg.action_attack = CONTROL_FIELD(Action_Attack, "Mouse Left, Gamepad RightTrigger, Left Ctrl, Right Ctrl");
    cfg.action_respawn = CONTROL_FIELD(Action_Respawn, "Mouse Left, Gamepad RightTrigger, Left Ctrl, Right Ctrl");
    cfg.modifier_run = CONTROL_FIELD(Modifier_Run, "Left Shift, Right Shift, Gamepad LeftTrigger");
    cfg.modifier_strafe = CONTROL_FIELD(Modifier_Strafe, "Left Alt, Right Alt");
    ...
    cfg.weapon_previous = CONTROL_FIELD(Weapon_Previous, "PageDown, [, Gamepad LeftShoulder, Gamepad Y");
    cfg.weapon_next = CONTROL_FIELD(Weapon_Next, "PageUp, ], Gamepad RightShoulder, Gamepad B");
    ...
    cfg.weapon_superShotgun = CONTROL_FIELD(Weapon_SuperShotgun, "4, Gamepad DpUp");
    cfg.weapon_chaingun = CONTROL_FIELD(Weapon_Chaingun, "5, Gamepad DpRight");
    cfg.weapon_rocketLauncher = CONTROL_FIELD(Weapon_RocketLauncher, "6, Gamepad DpDown");
    cfg.weapon_plasmaRifle = CONTROL_FIELD(Weapon_PlasmaRifle, "7, Gamepad DpLeft");
