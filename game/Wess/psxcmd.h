...
#if defined(__XBOX__)
    // PsyDoom Xbox: see the definition. For telling apart the three ways voices can fail to be reclaimed.
    void PSX_GetVoiceDiagCounts(uint32_t& numActive, uint32_t& numReleasing, uint32_t& numSpuOff, uint32_t& numActiveButSpuOff) noexcept;
#endif
