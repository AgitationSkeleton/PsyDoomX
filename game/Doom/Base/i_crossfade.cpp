...
#include "PsyDoom/Vulkan/VCrossfader.h"
...
#if defined(__XBOX__)
    // Crossfade animation is too CPU-intensive on the nxdk software renderer (52 SDL_RenderPresent
    // calls in a tight loop). Skip it entirely; the normal game loop renders the first frame.
    return;
#endif
