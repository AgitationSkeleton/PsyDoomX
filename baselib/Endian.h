...
// Force C++ linkage to avoid conflicts with C-linkage system headers when using inline overloads
// This fixes issues with nxdk cross-compiler that wraps system headers in extern "C"
extern "C++" {
